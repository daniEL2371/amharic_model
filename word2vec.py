...
batch, labels = generate_batch(batch_size=10, num_skips=2, skip_window=5)
...
params = [batch_size, embedding_size, skip_window, num_skips, num_sampled]
...
with tf.Session(graph=graph) as session:
    ...
    losses=','.join([str(i) for i in losses])
    text = params + " " + losses + '\n'
