...
class TextPreProcessor:
    ...
    def load_charset(self):
        ...
        self.n_consonants = len(char2tup)
        self.n_vowels = 10
    ...
    def encode_char(self, char):
        ...
        class_hot = one_hot_encode(class_code // 10, self.n_consonants)
...
processor = TextPreProcessor(text_file_path, charset_file, 100, 100)
